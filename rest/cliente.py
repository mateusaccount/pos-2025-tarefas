...
parser = argparse.ArgumentParser(description="CLI para gerenciamento de usuários JSONPlaceHolder")

parser.add_argument("action", choices=["list", "create", "read", "update", "delete"], help="Ação pra realizar")
parser.add_argument("id", help="ID do usuário")
parser.add_argument("data", help="Dados do user em Json (create/delete)")
